    ...
    this.circuits = {
      mintUnshieldedToSelfTest: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(domainSep_0).concat(_descriptor_4.toValue(amount_0)),
      ...
      mintUnshieldedToContractTest: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(domainSep_0).concat(_descriptor_2.toValue(address_0).concat(_descriptor_4.toValue(amount_0))),
      ...
      mintUnshieldedToUserTest: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(domainSep_0).concat(_descriptor_3.toValue(address_0).concat(_descriptor_4.toValue(amount_0))),
      ...
      sendUnshieldedToContractTest: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(color_0).concat(_descriptor_1.toValue(amount_0).concat(_descriptor_2.toValue(address_0))),
